...
<x-layouts.plain-app>
    ...
    <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8" x-data="productForm({
                ...
                <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="px-6 py-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select id="category_id" name="category_id" class="block w-full px-3 py-2 border @error('category_id') border-red-300 @else border-gray-300 @enderror rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input id="stock" name="stock" type="number" min="0" class="appearance-none block w-full px-3 py-2 border @error('stock') border-red-300 @else border-gray-300 @enderror rounded-md placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="0" value="{{ old('stock', $product->stock) }}">
                                    </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-1">
                                        <textarea id="description" name="description" rows="4" class="block w-full px-3 py-2 border @error('description') border-red-300 @else border-gray-300 @enderror rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Masukkan deskripsi produk">{{ old('description', $product->description) }}</textarea>
                                    </div>
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    <label for="price" class="block text-sm font-medium text-gray-700">Harga Normal <span class="text-red-500">*</span></label>
                                    <div class="mt-1 relative">
                                        ...
                                        <input id="price" name="price" type="number" min="0" step="0.01" class="appearance-none block w-full pl-10 pr-3 py-2 border @error('price') border-red-300 @else border-gray-300 @enderror rounded-md placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="0.00" value="{{ old('price', $product->price) }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><span class="text-gray-500 sm:text-sm">Rp</span></div>
                                        <input id="discount_price" name="discount_price" type="number" min="0" step="0.01" class="appearance-none block w-full pl-10 pr-3 py-2 border @error('discount_price') border-red-300 @else border-gray-300 @enderror rounded-md placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="0.00" value="{{ old('discount_price', $product->discount_price) }}">
                                    </div>
                                    @error('discount_price')<p class="mt-2 text-sm text-red-600">{{ $message }}</p>@enderror
                                </div>
                            </div>
                        </div>
                            ...
                            <div x-show="imagePreview.length > 0" class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                                <template x-for="(image, index) in imagePreview" :key="index">
                                    <div class="relative">
                                        ...
                                        <button type="button" @click="removeImage(index)" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div class="flex items-center">
                                <input id="is_active" name="is_active" type="checkbox" value="1" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" {{ old('is_active', $product->is_active) ? 'checked' : '' }}>
                                <label for="is_active" class="ml-2 block text-sm text-gray-900">Produk aktif dan dapat dijual</label>
                            </div>
                        </div>
                    </div>
