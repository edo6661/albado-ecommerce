    ...
    <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-extrabold text-gray-900">Edit Alamat</h1>
                <p class="mt-2 text-sm text-gray-600">
                    Perbarui detail alamat Anda. Anda bisa menggeser marker untuk menyesuaikan lokasi.
                </p>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                <form method="POST" action="{{ route('profile.addresses.update', $address->id) }}" class="p-6"
                        ...
                        <div class="flex flex-col space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" 
                                           id="address_search" 
                                           x-model="searchQuery"
                                           placeholder="Mulai ketik alamat baru jika ingin mengubah..."
                            ...
                            <div>
                                ...
                                <textarea id="street_address" 
                                          ...
                                          class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                          required>{{ old('street_address', $address->street_address) }}</textarea>
    ...
    <script>
        function addressForm() {
            return {
                searchQuery: '',
                formData: {
                    street_address: @json(old('street_address', $address->street_address)),
                    city: @json(old('city', $address->city)),
                    state: @json(old('state', $address->state)),
                    postal_code: @json(old('postal_code', $address->postal_code)),
                    country: @json(old('country', $address->country)),
